...
parseDirection :: Char -> Coords
parseDirection 'R' = (1,0)
parseDirection 'L' = (-1,0)
parseDirection 'U' = (0,1)
parseDirection 'D' = (0,-1)
parseDirection d = error ("Bad direction: " ++ show d)

-- "R3" -> [(1,0),(1,0),(1,0)]

parseSegment :: String -> [Coords]
...
parseWire :: String -> [[Coords]]
parseWire str = let
  segments = splitOnCommas str
  in map parseSegment segments

traceFullWire :: String -> WireState
traceFullWire str = let
...
closestConflict str1 str2 = let
  ...
  compareOnManhattan x y = compare (manhattanDistance x) (manhattanDistance y)
  in minimumBy compareOnManhattan $ map fst allConflicts

solvePart1 (str1, str2) = manhattanDistance $ closestConflict str1 str2

shortestConflict (str1, str2) = let
  allConflictSteps = map snd $ findConflicts str1 str2
  in minimum allConflictSteps

solvePart2 = shortestConflict
